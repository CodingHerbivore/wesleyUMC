<div class="row">
    <nav class="col navbar navbar-expand-md navbar-dark" id="topNav">
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarDiv" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
